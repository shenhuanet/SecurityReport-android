...
/**
 * 自定义MarkerView，使得最后一项高亮值不被遮挡，使用时需要传入LineChart对象，并重写getOffsetRight()方法
 * <p>
 * Created by shenhua on 2017/10/14.
 * Email shenhuanet@126.com
 */
public class BaseMarkerView extends RelativeLayout implements IMarker {
     ...
     */
    public BaseMarkerView(Context context, Chart chart, int layoutResource) {
        super(context);
