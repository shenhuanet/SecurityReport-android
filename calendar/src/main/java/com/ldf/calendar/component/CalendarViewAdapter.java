...
import com.ldf.calendar.listener.OnAdapterSelectListener;
...
public class CalendarViewAdapter extends PagerAdapter {
    ...
    // 0:代表周一显示为本周的第一天
    static int weekArrayType = 0;
    private static CalendarDate date = new CalendarDate();
    private ArrayList<Calendar> calendars = new ArrayList<>();
    private int currentPosition;
    private CalendarAttr.CalendayType calendarType = CalendarAttr.CalendayType.WEEK;
    private int rowCount = 0;
    private CalendarDate seedDate;

    public CalendarViewAdapter(Context context, IDayRenderer dayView, OnSelectDateListener onSelectDateListener) {
        super();
